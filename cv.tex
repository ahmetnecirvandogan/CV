...
\begin{document}
    ...
    \section{Experience}
        ...
        \begin{twocolentry}{
            ...
            \textbf{The International College Program Intern}, Walt Disney World -- Orlando, FL\end{twocolentry}
    ...
    \section{Education}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Koç University} Bachelor of Science - Mathematics\end{twocolentry}
    ...
    \section{Projects}
        ...
        \begin{twocolentry}{
            ...
            \textbf{
Interactive World Building with Environmental Control}\end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item An interactive 3D simulation that allows users to construct and manipulate a dynamic virtual world with real-time weather control and environmental interactions. 
                \item Built with OpenGL and C++, the simulation features a modular grid system, realistic lighting (using the Phong model), dynamic shadows, fluid simulations (e.g., rivers), and a day-night mode/cycle. 
                \item The system emphasizes user-driven creativity, offering an immersive experience through responsive environmental systems and real-time rendering techniques.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{
            Languages:} C++, C, Java, Python, MATLAB  \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{
            Technologies:} OpenGL, JavaFX, XCode, Microsoft Office Programs
        \end{onecolentry}
