...
\begin{document}
    ...
    \begin{twocolentry}{
            ...
            \textbf{Research Intern}, The University of Manchester -- UK
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item  Collaborating under the joint supervision of Dr. Zahra Montazeri and Prof. Metin Sezgin, aiming for publication in Computer Graphics, HCI \& AI.
            \end{highlights}
        \end{onecolentry}
           \vspace{0.10 cm} 
        \begin{twocolentry}{
