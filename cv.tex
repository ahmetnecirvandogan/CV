...
\begin{document}
    ...
    \begin{twocolentry}{
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item  Researching at the intersection of Computer Graphics, HCI, and AI in collaboration with The University of Manchester, targeting submission to a peer-reviewed publication.
            \end{highlights}
        \end{onecolentry}
           \vspace{0.10 cm} 
        \begin{twocolentry}{
