...
\begin{document}
    ...
    \begin{twocolentry}{
            ...
            \textbf{Research Intern}, Koç University -- Istanbul, Türkiye
        \end{twocolentry}
        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                \item  Collaborating with The University of Manchester under the joint supervision of Dr. Zahra Montazeri and Prof. Metin Sezgin, aiming for publication in Computer Graphics, HCI \& AI.
            \end{highlights}
        \end{onecolentry}
           \vspace{0.10 cm} 
        \begin{twocolentry}{
